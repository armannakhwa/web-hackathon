...
myApp.controller("myController", function ($scope) {
  ...
  $scope.search_s = search_s;

  $scope.get = function (rollno) {
    employees.map((stud, index) => {
      if (stud.rollno == rollno) {
        search_s.rollno = stud.rollno;
        search_s.name = stud.name;
        search_s.mcq = stud.mcq;
        search_s.nmcq = stud.nmcq;
